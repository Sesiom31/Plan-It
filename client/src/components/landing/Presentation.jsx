...
function Presentation() {
  return (
    <section className="h-auto w-full">
      <div className="grid min-h-[32rem] grid-cols-7 grid-rows-[repeat(4,auto)] place-items-center rounded-md lg:pt-4">
        <div className="col-span-7 row-span-1 mx-auto mt-4 text-center">
          <h1 className="h-full px-4 py-1 text-4xl font-medium tracking-wider text-gray-800 md:text-6xl lg:font-normal">
            Domina tu día con PlanIt
          </h1>
        </div>

        <div className="col-span-7 row-span-1 self-start text-center lg:col-span-3 lg:col-start-3 lg:row-start-2 lg:mt-12 lg:h-24">
        ...
        <figure className="col-span-7 row-span-1 mx-auto mt-6 aspect-[4/3] lg:hidden">
          <img
            src={welcome_center}
        ...
        <div className="col-span-7 row-span-1 row-start-4 mx-auto self-start lg:col-span-3 lg:col-start-3 lg:row-span-2 lg:row-start-3 lg:mt-8 lg:self-center">
          <RegisterAuthButton />
        </div>
      </div>
    </section>
